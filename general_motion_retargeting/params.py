...
ROBOT_XML_DICT = {
    ...
    "unitree_h2": ASSET_ROOT / "unitree_h2" / "scene.xml",
...
IK_CONFIG_DICT = {
    ...
    "xsens_mvn": {
        ...
        "unitree_h2": IK_CONFIG_ROOT / "xsens_mvn_to_h2.json",
    },
}
