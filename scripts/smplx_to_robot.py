...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=float,
        default=135.0,
        help="MuJoCo camera azimuth in degrees.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=-12.0,
        help="MuJoCo camera elevation in degrees.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="MuJoCo camera distance. Defaults to the robot-specific distance.",
    )
